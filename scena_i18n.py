...
from scena_tenant import NAME_RU as CANONICAL_NAME_RU, NAME_LATIN as CANONICAL_NAME_LATIN
...
{'Подготовьте вариант для соцсети. Материал и история отправок остаются в SCENA.': ('Pregătiți o '
 ...
 'Профессиональный beauty-портрет Софии': ('Portret beauty profesional al Sofiei',
                                           "Sofia's professional beauty portrait"),
