...
SERVICE_COPY = {
    'Дневной Makeup': (
        'Дневной макияж в Кишинёве. Выберите этот вариант, если планируете дневную встречу или повседневный образ. Перед визитом обсудите с Софией желаемые акценты; длительность и стоимость указаны в карточке услуги.',
        'Machiaj de zi în Chișinău. Alegeți această opțiune pentru o întâlnire în timpul zilei sau un look de zi cu zi. Discutați cu Sofia accentele dorite înainte de vizită; durata și prețul sunt afișate în fișa serviciului.',
        'Daytime makeup in Chișinău. Choose this option for a daytime occasion or an everyday look. Discuss the details you want with Sofia before your visit; the service card lists the duration and price.'),
    'Вечерний Makeup': (
        ...
        'Evening makeup in Chișinău for a special occasion. Tell Sofia about the event, your outfit and the look you have in mind. Choose an available time and your preferred contact channel to confirm the appointment.'),
    'Makeup Невеста': (
        'Свадебный макияж в Кишинёве. Начните с даты свадьбы и времени, к которому нужно быть готовой. Отправьте заявку на подходящий интервал; детали образа и запись София подтвердит лично. Пробный макияж и дополнительные услуги обсуждаются отдельно.',
        'Machiaj de mireasă în Chișinău. Începeți cu data nunții și ora la care trebuie să fiți gata. Trimiteți o cerere pentru intervalul potrivit; Sofia va confirma personal detaliile lookului și programarea. Proba și serviciile suplimentare se discută separat.',
        'Bridal makeup in Chișinău. Start with your wedding date and the time you need to be ready. Request a suitable appointment; Sofia will confirm the look and booking personally. Trials and additional services are discussed separately.'),
    'Сэлфи макияж': (
        'Курс «Сэлфи макияж» в Кишинёве — возможность обсудить обучение макияжу для себя. Оставьте контакты и напишите, какой образ хотите научиться создавать. София уточнит программу, формат и ближайшие даты; предзапись сама по себе не подтверждает место.',
        'Cursul de machiaj pentru selfie-uri în Chișinău vă permite să discutați despre învățarea machiajului pentru sine. Lăsați datele de contact și descrieți lookul pe care doriți să învățați să îl creați. Sofia va preciza programa, formatul și datele; preînscrierea nu confirmă automat locul.',
        'The Selfie Makeup course in Chișinău is an opportunity to discuss learning makeup for yourself. Leave your contact details and describe the look you want to learn. Sofia will explain the programme, format and upcoming dates; preregistration does not automatically confirm a place.'),
}
