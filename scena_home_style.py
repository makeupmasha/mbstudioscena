...
def scene_brand_markup(*, light=False):
    ...
    return ('<span class="scene-brand-badge"><span class="scene-brand-initials">SOFI</span>'
            '<span class="scene-brand-studio">LEROUX</span></span>'
...
def scene_brand_css():
    ...
    .scene-brand-initials{font:700 22px/20px Georgia,serif;letter-spacing:0}
    .scene-brand-studio{font:400 12px/20px SceneText,sans-serif;letter-spacing:0}
    ...
    @media(max-width:380px){.scene-brand-initials{font-size:20px}.scene-brand-studio{font-size:11px}.scene-brand-logo{width:116px}}
    '''
